...
public class U6_Script : MonoBehaviour {
	...
	void Start () {
		Prehub_mondai = (GameObject)Instantiate (House_Mondai, new Vector3 (23.23f, 31.14f, 42.55f), Quaternion.Euler (0, 81.8305f, 0));
	}
	...
	void Update () {
		...
		if (M_Timer >= 4.0f && M_Timer < 6.0f && hantei == false) {
			Prehub_listen = (GameObject)Instantiate (listen, new Vector3 (23.23f, 31.14f, 42.55f), Quaternion.Euler (0, 81.8305f, 0));
			hantei = true;
		}
