...
public class U4_Script : MonoBehaviour {
	...
	void Start () {
		Prehub_mondai = (GameObject)Instantiate (House_Mondai, new Vector3 (22.3f, 13.1f, 16.91f), Quaternion.Euler (0, 180f, 0));
	}
	...
	void Update () {
		...
		if (M_Timer >= 4.0f && M_Timer < 6.0f && hantei == false) {
			Prehub_listen = (GameObject)Instantiate (listen, new Vector3 (22.3f, 13.1f, 16.91f), Quaternion.Euler (0, 180f, 0));
			hantei = true;
		}
